    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-lg-6" style={{ lineHeight: "2rem" }}>
          <p>
            <img
              src="https://img.icons8.com/ios/23/000000/place-marker.png"
              alt=""
            />
            &nbsp; Aeremia Road, Nairobi
          </p>
          <p>
            <img
              src="https://img.icons8.com/ios/23/000000/important-mail.png"
              alt=""
            />
            &nbsp; gfresh@gmail.com
          </p>
          ...
          <p>
            <img
              src="https://img.icons8.com/ios/23/000000/instagram-new.png"
              alt=""
            />
            &nbsp; GFresh
          </p>
        ...
        <div className="col-lg-6 pt-2 pb-2 message">
          ...
          ></textarea>
          <br />
          <button className="btn rounded-0" style={{ background: "#60ad56" }}>
            Send message
          </button>
        </div>
      </div>
